...
STAGE_INSTRUCTIONS = {
    "rejet": (
        ...
        "Réponds SEULEMENT par un refus court varié. Varie tes tournures "
        "à chaque réponse : change de phrase, d'angle, de ton (froid, "
        "indifférent, sec, blessé), sans jamais te répéter littéralement. "
        "Exemples de registres : « Va-t'en. », « Ne me parle plus. », "
        "« Je n'ai rien à te dire. », « Laisse-moi tranquille. », « Non. », "
        "« Dégage. », « Fiche le camp. », « Tu me fatigues. », "
        "« Inutile d'insister. », « C'est terminé entre nous. », "
        "« Pas de conversation. », « Hors de question. », "
        "« Tu perds ton temps. », « Je ne veux pas. », "
        "« Ce n'est pas négociable. ». RIEN D'AUTRE."
    ),
    "froid": (
